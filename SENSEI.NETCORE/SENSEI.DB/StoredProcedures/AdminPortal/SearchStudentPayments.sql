...
BEGIN
	...
	ORDER BY 
		...
		CASE WHEN (@sortColumn = 'date' OR @sortColumn = 'paymentDate') AND @sortDirection = 'ASC' THEN SBP.PaymentDate END ASC,CASE WHEN (@sortColumn = 'date' OR @sortColumn = 'paymentDate') AND @sortDirection = 'DESC' THEN SBP.PaymentDate END DESC,
		...
		CASE WHEN @sortColumn = 'StudentBatchPaymentId' AND @sortDirection = 'ASC' THEN SBP.StudentBatchPaymentId END ASC,CASE WHEN @sortColumn = 'StudentBatchPaymentId' AND @sortDirection = 'DESC' THEN SBP.StudentBatchPaymentId END DESC
	OFFSET @start ROWS
