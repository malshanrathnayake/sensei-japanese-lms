...
BEGIN
	...
	WHERE 
		...
		AND (@searchValue = '' OR STREG.FirstName LIKE '%' + @searchValue + '%' OR STREG.LastName LIKE '%' + @searchValue + '%' OR STREG.MiddleName LIKE '%' + @searchValue + '%' OR CAST(STREG.CreatedDateTime AS DATE) LIKE '%' + @searchValue + '%' OR C.CourseName LIKE '%' + @searchValue + '%' OR SLM.LearningModeName LIKE '%' + @searchValue + '%' OR STREG.Email LIKE '%' + @searchValue + '%' OR STREG.PhoneNo LIKE '%' + @searchValue + '%' OR STREG.IndexNumber LIKE '%' + @searchValue + '%')
	ORDER BY 
