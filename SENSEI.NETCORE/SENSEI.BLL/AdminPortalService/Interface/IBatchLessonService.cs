...
namespace SENSEI.BLL.AdminPortalService.Interface
{
    public interface IBatchLessonService
    {
        ...
        Task<(IEnumerable<BatchLesson>, long)> SearchBatchLessons(long batchId = 0, int start = 0, int length = 10, string searchValue = "", string sortColumn = "", string sortDirection = "");
